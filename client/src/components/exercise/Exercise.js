...
function Exercise(props) {
  ...
  useEffect(() => {
    ...
    disableVisibilityIfEnabled(
      ...
      ACTIONS.NEGATE_EXERCISE_OPENED
    );
    disableVisibilityIfEnabled(
      state.isAddWindowOpened,
      ACTIONS.NEGATE_ADD_WINDOW_STATE
    );
    disableVisibilityIfEnabled(
      state.isRemoveWindowOpened,
      ACTIONS.NEGATE_REMOVE_WINDOW_STATE
    );
    disableVisibilityIfEnabled(
      state.isMoreWindowOpened,
      ACTIONS.NEGATE_MORE_WINDOW_STATE
    );
  }, [props.dateIds]);
        ...
        >
          ...
          {/* <ul className="exercise__series-section__summary">
            <li className="exercise__series-section__summary__item">
              <p className="exercise__series-section__summary__item__count">
                Total
              </p>
              <p className="exercise__series-section__summary__item__weight">
                {countTotalWeight(state.seriesList)} kg
              </p>
              <p className="exercise__series-section__summary__item__reps">
                {countTotalReps(state.seriesList)} reps
              </p>
            </li>
            ...
            <li className="exercise__series-section__summary__item">
              ...
              <p className="exercise__series-section__list__item__reps exercise__series-section__list__item__reps--stats">
                {countWeightPerRepsRatio(state.seriesList)} kg per rep
              </p>
            </li>
          </ul> */}
        </section>
